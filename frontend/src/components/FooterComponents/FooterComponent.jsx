...
import './FooterComponent.css'; // Make sure to create a CSS file for styling
    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-row">
          ...
          <div className="footer-column">
            ...
            <ul>
              ...
              <li>+1 234 567 890</li>
              <li>123 Farm Avenue, Agriculture City, USA</li>
            </ul>
          </div>
        ...
        <div className="footer-bottom">
          <p>&copy; {new Date().getFullYear()} Modern Farming. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
